    ...
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://res.cloudinary.com/mhmd/image/upload/v1556834130/avatar-3_hzlize.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Gaulthier Geelen</h5><span class="small text-uppercase text-muted">Webmaster</span>
          <ul class="social mb-0 list-inline mt-3">
            <li class="list-inline-item"><a href="#" class="social-link"><i class="fa fa-facebook-f"></i></a></li>
            <li class="list-inline-item"><a href="#" class="social-link"><i class="fa fa-twitter"></i></a></li>
            <li class="list-inline-item"><a href="#" class="social-link"><i class="fa fa-instagram"></i></a></li>
...
Ce produit devait être réalisé, soit en l’ayant pensé nous-mêmes soit en démarchant les entreprises
...
Nous nous sommes très vite penché sur le principe d'un vitre de protection, car c'était l'équipement de protection dont le marché n'avait pas encore été envahi. Afin de d'ajouter une valeur à notre produit, nous l'avons pensé modulable, pour être utilisable sur n'importe quelle surface. C'est donc dans cette optique que nous avons commencer notre travail pour en arriver à sa production et sa distribution.
  </div>
</div>
</div>
