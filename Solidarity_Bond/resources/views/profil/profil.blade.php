...
@section('content')
    ...
    <div class="container col-11">
        <div class="row mt-5 ">
            ...
            <div class="col-md-9">
                <div class="card mt-2">
                    <div class="card-body bg-light mt">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div id="corps">
                                    ...
                                    <form action="{{route('updateData')}}" method="post" class="mt-1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input id="Nom" name="Nom" value="{{Auth::user()->Nom}}"
                                                       class="form-control here @error('Nom') is-invalid @enderror"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input id="Prenom" name="Prenom" value="{{Auth::user()->Prenom}}"
                                                       class="form-control here @error('Prenom') is-invalid @enderror"
                                                       required="required" type="text">
                                                @error('Prenom')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input id="Mail" name="Mail" value="{{Auth::user()->Mail}}"
                                                       class="form-control here @error('Mail') is-invalid @enderror"
                                                       required="required" type="text">
                                                @error('Mail')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input id="Entreprise" name="Entreprise"
                                                       @if(Auth::user()->Entreprise!=null)value="{{Auth::user()->Entreprise}}"
                                                       @else value="" placeholder="Vide"
                                                       @endif class="form-control here @error('Entreprise') is-invalid @enderror"
                                                       required="required" type="text">
                                                @error('Entreprise')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input id="Telephone" name="Telephone"
                                                       @if(Auth::user()->Telephone!=null)value="{{Auth::user()->Telephone}}"
                                                       @else value="" placeholder="Vide"
                                                       @endif class="form-control here @error('Telephone') is-invalid @enderror"
                                                       required="required" type="text">
                                                @error('Telephone')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block mt-2">Modifier les
                                            données
                                        </button>
                                    </form>
                                    ...
                                    <form action="{{route('deleteUser')}}" method="post" class="mt-1">
                                        ...
                                        <!-- Delete event -->
                                        <button type="submit" class="btn btn-danger btn-block mt-2">Supprimer le
                                            compte
                                        </button>
                                    </form>
                                </div>
