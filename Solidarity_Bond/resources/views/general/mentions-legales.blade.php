...
@section('content')
    ...
    <div class="container col-11 mt-2 ">
        ...
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
            est précisé aux utilisateurs du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>
        ...
        <p><strong>Propriétaire</strong> : CESI – 34270750200718 – 19 Avenue Guy de Collongue, 69130 Écully<br/>
            ...
            <span class="infos-credits">Le modèle de mentions légales est offert par <a target="_blank"
                                                                                        href="https://www.subdelirium.com/generateur-de-mentions-legales/">Subdelirium.com</a></span>
        </p>

        <h3>2. Conditions générales d’utilisation du site et des services proposés.</h3>
        <p>L’utilisation du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> implique
            ...
            d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a
                href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> sont donc invités à les consulter de
            manière régulière.</p>
        <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
            maintenance technique peut être toutefois décidée par CESI, qui s’efforcera alors de communiquer
            préalablement aux utilisateurs les dates et heures de l’intervention.</p>
        <p>Le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> est mis à jour régulièrement par
            Loïs Cèbe. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent
            néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre
            connaissance.</p>


        <h3>3. Description des services fournis.</h3>
        <p>Le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> a pour objet de fournir une
            information concernant l’ensemble des activités de la société.</p>
        <p>CESI s’efforce de fournir sur le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> des
        ...
        <p>Tous les informations indiquées sur le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>
            sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant
            sur le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> ne sont pas exhaustifs. Ils
        ...
        <p>CESI est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les
        ...
        <p>CESI ne pourra être tenue responsable des dommages directs et indirects causés au matériel de l’utilisateur,
            lors de l’accès au site www.solidaritybond.fr, et résultant soit de l’utilisation d’un matériel ne répondant
            pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une incompatibilité.</p>
        <p>CESI ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de
            marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>.
        </p>
        <p>Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
            utilisateurs. CESI se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu déposé
            dans cet espace qui contreviendrait à la législation applicable en France, en particulier aux dispositions
            relatives à la protection des données. Le cas échéant, CESI se réserve également la possibilité de mettre en
        ...
        <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n°
            ...
            1995.</p>
        <p>A l'occasion de l'utilisation du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>,
            peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>, le fournisseur d'accès de l'utilisateur,
            l'adresse de protocole Internet (IP) de l'utilisateur.</p>
        <p> En tout état de cause CESI ne collecte des informations personnelles relatives à l'utilisateur que pour le
            besoin de certains services proposés par le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>.
            ...
            lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a
                href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> l’obligation ou non de fournir ces
            informations.</p>
        ...
        <p>Aucune information personnelle de l'utilisateur du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>
            n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à
            des tiers. Seule l'hypothèse du rachat de CESI et de ses droits permettrait la transmission des dites
            informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de
            modification des données vis à vis de l'utilisateur du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>.
        </p>
        ...
        <p>Le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> contient un certain nombre de liens
            hypertextes vers d’autres sites, mis en place avec l’autorisation de CESI. Cependant, CESI n’a pas la
        ...
        <p>La navigation sur le site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a> est susceptible
        ...
        <p>Tout litige en relation avec l’utilisation du site <a href="http://www.solidaritybond.fr/">www.solidaritybond.fr</a>
